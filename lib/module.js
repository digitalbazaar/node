...
function tryFile(requestPath) {
  ...
  console.log('@@@@@@@@@TRYFILE:', requestPath);
  console.log('#########-RC', rc);
  if(rc === 0) console.log('TOREALPATH', toRealPath(requestPath));
  // NOTE: requestPath here is the symlink and the return is the resolved path
...
Module._findPath = function(request, paths) {
  ...
  for (var i = 0, PL = paths.length; i < PL; i++) {
    ...
    console.log('PATH GOING IN TO RESOLVE', paths[i]);
    var basePath = path.resolve(paths[i], request);
    console.log('PATH COMING OUT OF RESOLVE', basePath);
    var filename;
    ...
    if (!trailingSlash) {
      ...
      console.log('FILENAME AFTER RC', filename);
      if (!filename) {
...
Module._nodeModulePaths = function(from) {
  ...
  console.log('MODULE.NODEMODULEPATHS.FROM:', from);
...
Module._resolveLookupPaths = function(request, parent) {
  ...
  if (start !== './' && start !== '..') {
    ...
    if (parent) {
      ...
      // console.log('$$$$$$$$$$$$$PARENTPATHS', JSON.stringify(parent.paths, null , 2));
...
Module._load = function(request, parent, isMain) {
  ...
  console.log('MODULE._LOAD.FILENAME', filename);
...
Module._resolveFilename = function(request, parent) {
  console.log('MODULE._RESOLVEFILENAME(request):', request);
  // console.log('MODULE._RESOLVEFILENAME(parent):', parent);
  if (NativeModule.nonInternalExists(request)) {
    return request;
  }
